...
/* 
  We’ll use a container + child approach to create a subtle “typewriter” effect
  for the main heading. Each character will fade/slide in sequentially.
*/
const typewriterContainer = {
  ...
  visible: {
    opacity: 1,
    transition: {
      // Controls the stagger delay between each letter’s entrance
...
*/
const MBA = () => {
  // Split your heading text into letters for the typewriter effect
  const headingText = "MBA & PGDM Overview";
  ...
  return (
    <div className="w-full overflow-x-hidden min-h-screen flex flex-col">
      {/*
        Hero Section
        - Gradient background (blue → cyan → indigo)
        - Subtle text color improvements
        - Typewriter effect on main heading
      */}
      <section className="flex-1 bg-gradient-to-br from-blue-200 via-cyan-200 to-indigo-200 flex flex-col justify-center items-center text-gray-900 relative px-6 py-20">
        <motion.h1
          // Parent container for the typewriter effect
        ...
        <motion.p
          ...
          initial="hidden"
          animate="visible"
          transition={{ duration: 0.6, delay: 1.0 }} // Delay so it starts after heading
          className="text-lg md:text-xl max-w-3xl text-center mb-8 text-gray-800 mt-2"
        >
          Explore the world of business administration and discover how an MBA
          or PGDM can transform your career. Select a section below to learn
          more!
        </motion.p>
      </section>
      ...
      {/*
        Links Section
        - Elevated card styling with bigger rounded corners & smooth shadows
        - Maintain the white background contrast
      */}
      <section className="bg-white -mt-16 rounded-t-3xl shadow-2xl p-8 z-10">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Link #1: MBA — What's That All About? */}
          <motion.div
            variants={fadeInUp}
            initial="hidden"
            whileInView="visible"
          ...
          >
            ...
            <p className="text-gray-700 mb-4">
              A prestigious graduate degree equipping individuals with
              comprehensive business skills and knowledge...
            </p>
            <Link
              to="/mba/what-its-all-about"
          ...
          {/* Link #2: PGDM — Like MBA but Not MBA */}
          <motion.div
            variants={fadeInUp}
            initial="hidden"
            whileInView="visible"
          ...
          >
            ...
            <p className="text-gray-700 mb-4">
              A two-year full-time program that’s more industry-focused with
          ...
          {/* Link #3: Difference Between PGDM & MBA */}
          <motion.div
            variants={fadeInUp}
            initial="hidden"
            whileInView="visible"
          ...
          >
            <h2 className="text-xl font-bold mb-2 text-gray-900">
              Aren’t PGDM and MBA the Same?
            </h2>
            <p className="text-gray-700 mb-4">
              Learn how their structure, affiliation, and focus set them
              apart...
            </p>
            <Link
              to="/mba/difference-pgdm-mba"
              className="text-indigo-600 font-semibold hover:text-indigo-800 transition-colors"
            >
              Read More &rarr;
            </Link>
          ...
          >
            <h2 className="text-xl font-bold mb-2 text-gray-900">
              Give Me One Reason to Do an MBA!
            </h2>
            <p className="text-gray-700 mb-4">
              Well, here are four — from career change to higher salary...
            </p>
            <Link
              to="/mba/reasons-to-do-mba"
              className="text-indigo-600 font-semibold hover:text-indigo-800 transition-colors"
            >
              Read More &rarr;
            </Link>
          ...
          >
            ...
            <p className="text-gray-700 mb-4">
              Check eligibility requirements, FAQs, entrance exams, and more...
            </p>
            <Link
              to="/mba/eligibility"
              className="text-indigo-600 font-semibold hover:text-indigo-800 transition-colors"
          ...
          >
            ...
            <p className="text-gray-700 mb-4">
              A curated list of India’s best institutions for management...
            </p>
            <Link
              to="/mba/top-b-schools"
              className="text-indigo-600 font-semibold hover:text-indigo-800 transition-colors"
            >
              Read More &rarr;
            </Link>
          ...
          >
            ...
            <p className="text-gray-700 mb-4">
              CAT, XAT, GMAT, CMAT... figure out which exam suits your goals!
            </p>
            <Link
              to="/mba/entrance-exams"
              className="text-indigo-600 font-semibold hover:text-indigo-800 transition-colors"
            >
              Read More &rarr;
            </Link>
